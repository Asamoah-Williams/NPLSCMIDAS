...
class DatabaseConnection:
    ...
    def get_db_connection(self):
            ...
            params = urllib.parse.quote_plus(f"DRIVER={{ODBC Driver 17 for SQL Server}};SERVER={self.db_config['server']};DATABASE={self.db_config['database']};UID={self.db_config['username']};PWD={self.db_config['password']};TrustServerCertificate=yes;")
